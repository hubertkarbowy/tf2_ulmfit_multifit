...
def make_fastai_learner(*, args, x_train, y_train, x_test, y_test, label_map, splits):
    ...
    clas_config.update({'n_layers': args['num_recurrent_layers']})
...
if __name__ == "__main__":
    ...
    argz.add_argument("--num-recurrent-layers", required=False, type=int, help="Number of recurrent layers in the encoder")
    ...
    if argz.get('num_recurrent_layers') is None:
        argz['num_recurrent_layers'] = 4 if argz.get('qrnn') else 3
